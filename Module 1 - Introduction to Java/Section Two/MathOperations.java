public class MathOperations {
    ...
    public static void main(String [] args) {
        ...
        System.out.println("Fred has " + (bagOfSweets2 - bagOfSweets1) + " more sweets than George sweets");
        ...
        System.out.println("5 is an even number, since dividing 5 by 2 has a remainder of: " + (5 % 2));
